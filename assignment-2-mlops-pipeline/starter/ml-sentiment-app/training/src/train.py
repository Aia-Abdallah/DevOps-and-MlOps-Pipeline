...
if __name__ == "__main__":
    ...
    experiment_name = f"{config['mlflow']['experiment_name']}-{timestamp}"
    ...
    # Run everything inside MLflow parent run
    with mlflow.start_run(run_name="main-experiment"):
        mlflow.log_param("model_name", model_name)
        mlflow.log_param("eval_dataset", eval_path)
